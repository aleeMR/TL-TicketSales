...
class Home extends React.Component {
    ...
    onChangeCheckbox(event){
        ...
        let index = tickets.findIndex(t => t.title === name);
        tickets[index].check = !tickets[index].check;
        this.setState(this.state);
    }
                ...
                <Form onSubmit={ this.handleForm.bind(this) }>
                    <Row>
                        <Col sm={4} className="container-btns">
                            <Button className="px-5 style-button btn-util" type="submit">
                                Vender boletas seleccionadas
                            </Button>
                            <Link to="/tickets">
                                <Button className="mt-4 px-5 style-button btn-on">
                                    Ver boletas vendidas
                                </Button>
                            </Link>
                        </Col>
